    ...
    <div className="space-y-6 w-full animate-fade-in">
       <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
            ...
            <p className="text-slate-500">Emissão de documentos oficiais e análise fiscal.</p>
        </div>
        <button 
            ...
            ${hasData ? 'bg-indigo-900 text-white hover:bg-indigo-800' : 'bg-slate-200 text-slate-400 cursor-not-allowed'}`}
        >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="space-y-6">
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 flex-1">
                <h3 className="text-lg font-bold text-slate-800 mb-4">Balanço Geral</h3>
